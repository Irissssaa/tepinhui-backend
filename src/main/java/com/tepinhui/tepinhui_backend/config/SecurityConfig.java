    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/user/reviews").hasAnyRole("CONSUMER", "ADMIN")
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/orders/calculate").hasAnyRole("ADMIN", "CONSUMER")
                ...
                .requestMatchers(HttpMethod.DELETE, "/api/v1/reviews/*").hasAnyRole("CONSUMER", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/v1/orders/*/pay").hasAnyRole("ADMIN", "CONSUMER")
